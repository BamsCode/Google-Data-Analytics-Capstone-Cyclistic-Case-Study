...
Quick links:
Data Source: divvy_tripdata [accessed on 04/01/24]

R: https://github.com/BamsCode/Google-Data-Analytics-Capstone-Cyclistic-Case-Study/blob/main/Cyclistic%20Case%20Study.Rmd
...
Combining the Data
R: Data Combining
12 csv files are uploaded as tables in the dataset '2023_tripdata'. Another table named "combined_data" is created, containing 5,667,717 rows of data for the entire year.

Data Exploration
RStudio: Data Exploration
